...
export namespace challenge {
	...
	export function list(label: ChallengeLabel | undefined) {
		if (label) return request.post<ChallengeInfo[]>(base(`list/${label}`));
		else return request.post<ChallengeInfo[]>(base("list"));
	}
